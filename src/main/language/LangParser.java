...
public class LangParser extends Parser {
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			while (_la==ADD || _la==SUB) {
				...
				{
				setState(7);
				((ExprContext)_localctx)._tset58 = _input.LT(1);
				_la = _input.LA(1);
				if ( !(_la==ADD || _la==SUB) ) {
					((ExprContext)_localctx)._tset58 = (Token)_errHandler.recoverInline(this);
				}
				else {
				...
				((ExprContext)_localctx).op.add(((ExprContext)_localctx)._tset58);
				setState(8);
	...
	public final AddContext add() throws RecognitionException {
		...
		try {
			...
			while (_la==MUL || _la==DIV) {
				...
				{
				setState(15);
				((AddContext)_localctx)._tset78 = _input.LT(1);
				_la = _input.LA(1);
				if ( !(_la==MUL || _la==DIV) ) {
					((AddContext)_localctx)._tset78 = (Token)_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
					_errHandler.reportMatch(this);
				...
				((AddContext)_localctx).op.add(((AddContext)_localctx)._tset78);
				setState(16);
	...
	public static final String _serializedATN =
		...
		"\2\5\2\4\6\2\4\3\2\7\b\3\2\t\n\2#\2\b\3\2\2\2\4\20\3\2\2\2\6\31\3\2\2"+
		"\2\b\r\5\4\3\2\t\n\t\2\2\2\n\f\5\4\3\2\13\t\3\2\2\2\f\17\3\2\2\2\r\13"+
		"\3\2\2\2\r\16\3\2\2\2\16\3\3\2\2\2\17\r\3\2\2\2\20\25\5\6\4\2\21\22\t"+
		"\3\2\2\22\24\5\6\4\2\23\21\3\2\2\2\24\27\3\2\2\2\25\23\3\2\2\2\25\26\3"+
		"\2\2\2\26\5\3\2\2\2\27\25\3\2\2\2\30\32\7\b\2\2\31\30\3\2\2\2\31\32\3"+
		"\2\2\2\32 \3\2\2\2\33!\7\5\2\2\34\35\7\3\2\2\35\36\5\2\2\2\36\37\7\4\2"+
		"\2\37!\3\2\2\2 \33\3\2\2\2 \34\3\2\2\2!\7\3\2\2\2\6\r\25\31 ";
